 ...
 */
public class NewSaleAdapter extends RecyclerView.Adapter<NewSaleAdapter.ProductViewHolder> {
    ...
    public NewSaleAdapter(Context context) {
        mContext = context;
    }



    public NewSaleAdapter(Context context, ArrayList<StockItem> stockItems, ConfigImageHelper configImageHelper){
        mContext = context;
