 ...
 */
public class GroupModelStockAdapter extends RecyclerView.Adapter<GroupModelStockAdapter.ProductViewHolder> {
    ...
    public GroupModelStockAdapter(Context context) {
        mContext = context;
    }



    public GroupModelStockAdapter(Context context, ArrayList<StockItem> stockItems, ConfigImageHelper configImageHelper){
        mContext = context;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View view = LayoutInflater.from(mContext).inflate(R.layout.group_model_stock_item, parent, false);
